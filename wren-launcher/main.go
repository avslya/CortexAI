...
import (
	...
	"github.com/Canner/CortexAI/wren-launcher/commands"
	"github.com/Canner/CortexAI/wren-launcher/config"
...
func showHelp() {
	pterm.Info.Println("Usage of Cortex launcher:")
	pterm.Info.Println("")
	pterm.Info.Println("Commands:")
	pterm.Info.Println("  (default)                                        Launch Cortex AI service")
	pterm.Info.Println("  dbt-auto-convert --path --output [--profile] [--target]    Auto-convert dbt project to CortexDataSource and Cortex MDL")
	pterm.Info.Println("")
	pterm.Info.Println("Flags:")
	flag.PrintDefaults()
	pterm.Info.Println("")
	pterm.Info.Println("Examples:")
	pterm.Info.Println("  wren-launcher                                              # Launch Cortex AI")
