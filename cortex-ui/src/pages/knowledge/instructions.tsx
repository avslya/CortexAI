  ...
  return (
    <SiderLayout loading={false}>
      <PageLayout
        ...
        description={
          <>
            On this page, you can manage saved instructions that guide cortex ai
            in generating SQL queries. These instructions help cortex ai
            ...
            <Link
              ...
              href="https://docs.getcortex.ai/oss/guide/knowledge/instructions"
