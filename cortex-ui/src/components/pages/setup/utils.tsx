...
export const DATA_SOURCE_OPTIONS = {
  [DATA_SOURCES.BIG_QUERY]: {
    ...
    guide: 'https://docs.getcortex.ai/oss/guide/connect/bigquery',
    disabled: false,
  },
  [DATA_SOURCES.DUCKDB]: {
    ...getDataSourceConfig(DATA_SOURCES.DUCKDB),
    guide: 'https://docs.getcortex.ai/oss/guide/connect/duckdb',
    disabled: false,
  },
  [DATA_SOURCES.POSTGRES]: {
    ...getDataSourceConfig(DATA_SOURCES.POSTGRES),
    guide: 'https://docs.getcortex.ai/oss/guide/connect/postgresql',
    disabled: false,
  },
  [DATA_SOURCES.MYSQL]: {
    ...getDataSourceConfig(DATA_SOURCES.MYSQL),
    guide: 'https://docs.getcortex.ai/oss/guide/connect/mysql',
    disabled: false,
  },
  [DATA_SOURCES.ORACLE]: {
    ...getDataSourceConfig(DATA_SOURCES.ORACLE),
    guide: 'https://docs.getcortex.ai/oss/guide/connect/oracle',
    disabled: false,
  },
  [DATA_SOURCES.MSSQL]: {
    ...getDataSourceConfig(DATA_SOURCES.MSSQL),
    guide: 'https://docs.getcortex.ai/oss/guide/connect/sqlserver',
    disabled: false,
  },
  [DATA_SOURCES.CLICK_HOUSE]: {
    ...getDataSourceConfig(DATA_SOURCES.CLICK_HOUSE),
    guide: 'https://docs.getcortex.ai/oss/guide/connect/clickhouse',
    disabled: false,
  },
  [DATA_SOURCES.TRINO]: {
    ...getDataSourceConfig(DATA_SOURCES.TRINO),
    guide: 'https://docs.getcortex.ai/oss/guide/connect/trino',
    disabled: false,
  },
  [DATA_SOURCES.SNOWFLAKE]: {
    ...getDataSourceConfig(DATA_SOURCES.SNOWFLAKE),
    guide: 'https://docs.getcortex.ai/oss/guide/connect/snowflake',
    disabled: false,
  },
  [DATA_SOURCES.ATHENA]: {
    ...getDataSourceConfig(DATA_SOURCES.ATHENA),
    guide: 'https://docs.getcortex.ai/oss/guide/connect/athena',
    disabled: false,
  },
  [DATA_SOURCES.REDSHIFT]: {
    ...getDataSourceConfig(DATA_SOURCES.REDSHIFT),
    guide: 'https://docs.getcortex.ai/oss/guide/connect/redshift',
    disabled: false,
  },
...
export const TEMPLATE_OPTIONS = {
  [SampleDatasetName.ECOMMERCE]: {
    ...
    guide: 'https://docs.getcortex.ai/oss/getting_started/sample_data/ecommerce',
  },
  [SampleDatasetName.HR]: {
    label: 'Human Resource',
    IconComponent: IdCardOutlined,
    guide: 'https://docs.getcortex.ai/oss/getting_started/sample_data/hr',
  },
};
  ...
  if (error.code === ERROR_CODES.CONNECTION_REFUSED) {
    return (
      <div>
        ...
        refer to our{' '}
        <a
          href="https://docs.getcortex.ai/oss/guide/connect/postgresql#connect"
          target="_blank"
