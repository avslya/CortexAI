...
const knowledgeTooltip = (
  <>
    Store this answer as a Question-SQL pair to help cortex ai improve SQL
    generation.
    <br />
    <Typography.Link
      className="gray-1 underline"
      href="https://docs.getcortex.ai/oss/guide/knowledge/question-sql-pairs#save-to-knowledge"
      target="_blank"
