      ...
      popover: {
        ...
        description: renderToString(
          <>
            ...
            meaningful insights.{' '}
            <a
              href="https://docs.getcortex.ai/oss/guide/modeling/overview"
              target="_blank"
  ...
  $driver.setSteps([
    {
      ...
      popover: {
        ...
        description: renderToString(
          <>
            Create and manage <b>Question-SQL pairs</b> to refine cortex ai’s SQL
            ...
            save, the smarter cortex ai becomes!
          </>,
        ),
        onPopoverRender: (popoverDom: DriverPopoverDOM) => {
      ...
      popover: {
        ...
        description: renderToString(
          <>
            ...
            guide cortex ai in applying consistent filters, constraints, and best
