...
const getData = (
  ...
  const modeling = [
    ...
    },
    {
      ...
      href: 'https://docs.getcortex.ai/oss/guide/connect/overview',
  ...
  const home = [
    ...
    },
    {
      ...
      title: 'View full SQL',
      href: 'https://docs.getcortex.ai/oss/guide/home/answer#view-sqlview-full-sql',
