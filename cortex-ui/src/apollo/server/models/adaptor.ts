...
export type cortexSQL = Brand<string, 'cortexSQL'>;

export interface cortexAIError {
  code: Errors.GeneralErrorCodes;
  message: string;
}

export enum cortexAIDeployStatusEnum {
  SUCCESS = 'SUCCESS',
  FAILED = 'FAILED',
}

export interface cortexAIDeployResponse {
  status: cortexAIDeployStatusEnum;
  error?: string;
}

export enum cortexAISystemStatus {
  INDEXING = 'INDEXING',
  FINISHED = 'FINISHED',
  FAILED = 'FAILED',
}

export enum cortexAILanguage {
  EN = 'English',
  ES = 'Spanish',
  FR = 'French',
