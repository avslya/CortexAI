...
export const sampleDatasets: Record<string, SampleDataset> = {
    ...
    tables: [
      {
        tableName: 'salaries',
        filePath:
          'https://assets.getcortex.ai/sample_data/employees/salaries.parquet',
        schema: [
      ...
      },
      {
        tableName: 'titles',
        filePath:
          'https://assets.getcortex.ai/sample_data/employees/titles.parquet',
        schema: [
          { columnName: 'emp_no', dataType: 'INTEGER' },
      ...
      },
      {
        tableName: 'dept_emp',
        filePath:
          'https://assets.getcortex.ai/sample_data/employees/dept_emp.parquet',
        schema: [
          { columnName: 'emp_no', dataType: 'INTEGER' },
      ...
      },
      {
        ...
        filePath:
          'https://assets.getcortex.ai/sample_data/employees/departments.parquet',
        schema: [
      ...
      },
      {
        tableName: 'employees',
        filePath:
          'https://assets.getcortex.ai/sample_data/employees/employees.parquet',
        schema: [
      ...
      },
      {
        ...
        filePath:
          'https://assets.getcortex.ai/sample_data/employees/dept_manager.parquet',
        schema: [
          { columnName: 'from_date', dataType: 'DATE' },
          { columnName: 'to_date', dataType: 'DATE' },
          { columnName: 'emp_no', dataType: 'INTEGER' },
  ...
  music: {
    ...
    tables: [
      {
        tableName: 'album',
        filePath: 'https://cortexai-public.s3.amazonaws.com/demo/Music/Album.csv',
        schema: [
      ...
      },
      {
        tableName: 'artist',
        filePath:
          'https://cortexai-public.s3.amazonaws.com/demo/Music/Artist.csv',
        schema: [
          { columnName: 'ArtistId', dataType: 'INT' },
      ...
      },
      {
        tableName: 'customer',
        filePath:
          'https://cortexai-public.s3.amazonaws.com/demo/Music/Customer.csv',
        schema: [
      ...
      {
        tableName: 'genre',
        filePath: 'https://cortexai-public.s3.amazonaws.com/demo/Music/Genre.csv',
        schema: [
      ...
      },
      {
        tableName: 'invoice',
        filePath:
          'https://cortexai-public.s3.amazonaws.com/demo/Music/Invoice.csv',
        schema: [
      ...
      },
      {
        ...
        filePath:
          'https://cortexai-public.s3.amazonaws.com/demo/Music/InvoiceLine.csv',
        schema: [
      ...
      {
        tableName: 'track',
        filePath: 'https://cortexai-public.s3.amazonaws.com/demo/Music/Track.csv',
        schema: [
          { columnName: 'TrackId', dataType: 'BIGINT' },
          { columnName: 'Name', dataType: 'VARCHAR' },
    ...
    tables: [
      {
        ...
        filePath:
          'https://assets.getcortex.ai/sample_data/brazilian-ecommerce/olist_customers_dataset.parquet',
        properties: {
      ...
      },
      {
        ...
        filePath:
          'https://assets.getcortex.ai/sample_data/brazilian-ecommerce/olist_order_items_dataset.parquet',
        properties: {
      ...
      },
      {
        ...
        primaryKey: 'order_id',
        filePath:
          'https://assets.getcortex.ai/sample_data/brazilian-ecommerce/olist_orders_dataset.parquet',
        properties: {
          displayName: 'orders',
          description:
      ...
      },
      {
        ...
        primaryKey: 'order_id',
        filePath:
          'https://assets.getcortex.ai/sample_data/brazilian-ecommerce/olist_order_payments_dataset.parquet',
        properties: {
      ...
      },
      {
        ...
        filePath:
          'https://assets.getcortex.ai/sample_data/brazilian-ecommerce/olist_products_dataset.parquet',
        properties: {
      ...
      },
      {
        ...
        filePath:
          'https://assets.getcortex.ai/sample_data/brazilian-ecommerce/olist_order_reviews_dataset.parquet',
        properties: {
      ...
      },
      {
        ...
        primaryKey: '',
        filePath:
          'https://assets.getcortex.ai/sample_data/brazilian-ecommerce/olist_geolocation_dataset.parquet',
        properties: {
      ...
      },
      {
        ...
        primaryKey: '',
        filePath:
          'https://assets.getcortex.ai/sample_data/brazilian-ecommerce/olist_sellers_dataset.parquet',
        properties: {
          displayName: 'sellers',
          description:
      ...
      },
      {
        ...
        filePath:
          'https://assets.getcortex.ai/sample_data/brazilian-ecommerce/product_category_name_translation.parquet',
        properties: {
    ...
    tables: [
      {
        ...
        primaryKey: 'Id',
        filePath:
          'https://cortexai-public.s3.amazonaws.com/demo/v0.3.0/NBA/game.csv',
        columns: [
          {
            name: 'Id',
          },
      ...
      },
      {
        ...
        primaryKey: 'GameId',
        filePath:
          'https://cortexai-public.s3.amazonaws.com/demo/v0.3.0/NBA/line_score.csv',
        columns: [
          {
            name: 'GameId',
          },
      ...
      },
      {
        ...
        primaryKey: 'Id',
        filePath:
          'https://cortexai-public.s3.amazonaws.com/demo/v0.3.0/NBA/player_game.csv',
        columns: [
          {
            name: 'Id',
          },
      ...
      },
      {
        ...
        primaryKey: 'Id',
        filePath:
          'https://cortexai-public.s3.amazonaws.com/demo/v0.3.0/NBA/player.csv',
        columns: [
          {
            name: 'Id',
          },
      ...
      },
      {
        ...
        primaryKey: 'Id',
        filePath:
          'https://cortexai-public.s3.amazonaws.com/demo/v0.3.0/NBA/team.csv',
        columns: [
          {
            name: 'Id',
          },
