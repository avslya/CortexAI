    ...
    setInterval(() => {
      const jobs = Object.values(this.tasks).map(
        (threadResponse) => async () => {
          ...
          const result = await this.cortexAIAdaptor.getAskDetailResult(
...
export class AskingService implements IAskingService {
  ...
  public async getThreadRecommendationQuestions(
    ...
    if (thread.queryId && thread.questionsStatus) {
      ...
      res.error = thread.questionsError as cortexAIError;
    }
    return res;
  }
  ...
  public async generateThreadRecommendationQuestions(
    ...
    const result = await this.cortexAIAdaptor.generateRecommendationQuestions(
  ...
  public async generateThreadResponseBreakdown(
    ...
    const response = await this.cortexAIAdaptor.generateAskDetail({
  ...
  public async generateThreadResponseChart(
    ...
    const response = await this.cortexAIAdaptor.generateChart({
      query: threadResponse.question,
      sql: threadResponse.sql,
      configurations,
    });
  ...
  public async adjustThreadResponseChart(
    ...
    const response = await this.cortexAIAdaptor.adjustChart({
      query: threadResponse.question,
      sql: threadResponse.sql,
  ...
  public async createInstantRecommendedQuestions(
    ...
    const response = await this.cortexAIAdaptor.generateRecommendationQuestions({
      manifest,
  ...
  public async getInstantRecommendedQuestions(
    ...
    const response =
      await this.cortexAIAdaptor.getRecommendationQuestionsResult(queryId);
    return response;
  }
  ...
  private getThreadRecommendationQuestionsConfig(project: Project) {
    return {
      ...
      configuration: {
        language: cortexAILanguage[project.language] || cortexAILanguage.EN,
      },
    };
  }
}
