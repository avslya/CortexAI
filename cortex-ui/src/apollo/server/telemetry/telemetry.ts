...
export class PostHogTelemetry {
  ...
  public async sendEvent(
    event: TelemetryEvent,
    properties: Record<string, any> = {},
    service: cortexService | any = cortexService.UNKNOWN,
  ...
  private collectSystemInfo(): Record<string, any> {
    return {
      ...
      'cortex-ui-version': cortexUIVersion || null,
      'cortex-engine-version': cortexEngineVersion || null,
      'cortex-ai-service-version': cortexAIVersion || null,
