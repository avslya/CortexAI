...
export class MDLBuilder implements IMDLBuilder {
  ...
  public addModel(): void {
    ...
    this.manifest.models = this.models.map((model: Model) => {
      ...
      return {
        ...
        refSql: this.useRustcortexEngine()
          ? null
          : tableReference
            ? null
            : model.refSql,
  ...
  private useRustcortexEngine(): boolean {
    return !!config.experimentalEngineRustVersion;
  }
  private buildDataSource(): cortexEngineDataSourceType {
    ...
    switch (type) {
      case DataSourceName.ATHENA:
        return cortexEngineDataSourceType.ATHENA;
      case DataSourceName.BIG_QUERY:
        return cortexEngineDataSourceType.BIGQUERY;
      case DataSourceName.DUCKDB:
        return cortexEngineDataSourceType.DUCKDB;
      case DataSourceName.POSTGRES:
        return cortexEngineDataSourceType.POSTGRES;
      case DataSourceName.MYSQL:
        return cortexEngineDataSourceType.MYSQL;
      case DataSourceName.ORACLE:
        return cortexEngineDataSourceType.ORACLE;
      case DataSourceName.MSSQL:
        return cortexEngineDataSourceType.MSSQL;
      case DataSourceName.CLICK_HOUSE:
        return cortexEngineDataSourceType.CLICKHOUSE;
      case DataSourceName.TRINO:
        return cortexEngineDataSourceType.TRINO;
      case DataSourceName.SNOWFLAKE:
        return cortexEngineDataSourceType.SNOWFLAKE;
      case DataSourceName.REDSHIFT:
        return cortexEngineDataSourceType.REDSHIFT;
      default:
        throw new Error(
