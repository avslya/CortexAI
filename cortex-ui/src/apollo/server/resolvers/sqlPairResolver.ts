...
import { DialectSQL, cortexSQL } from '@server/models/adaptor';
...
export class SqlPairResolver {
  ...
  public async modelSubstitute(
    ...
    const cortexSQL = await ctx.sqlPairService.modelSubstitute(
    ...
    return safeFormatSQL(cortexSQL, { language: 'postgresql' }) as cortexSQL;
  }
