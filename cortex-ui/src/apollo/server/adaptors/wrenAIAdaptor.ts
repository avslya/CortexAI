...
import {
  ...
  cortexAIDeployStatusEnum,
  cortexAISystemStatus,
  cortexAIDeployResponse,
  DeployData,
  AskInput,
...
const logger = getLogger('cortexAIAdaptor');
logger.level = 'debug';
...
export interface IcortexAIAdaptor {
  deploy(deployData: DeployData): Promise<cortexAIDeployResponse>;
...
export class cortexAIAdaptor implements IcortexAIAdaptor {
  private readonly cortexAIBaseEndpoint: string;

  constructor({ cortexAIBaseEndpoint }: { cortexAIBaseEndpoint: string }) {
    this.cortexAIBaseEndpoint = cortexAIBaseEndpoint;
  }
  ...
  public async delete(projectId: number): Promise<void> {
    try {
      ...
      const url = `${this.cortexAIBaseEndpoint}/v1/semantics`;
      ...
      if (response.status === 200) {
        logger.info(`cortex ai: Deleted semantics for project ${projectId}`);
      } else {
        throw new Error(`Failed to delete semantics. ${response.data?.error}`);
      }
    } catch (error: any) {
      throw new Error(
        `cortex ai: Failed to delete semantics: ${getAIServiceError(error)}`,
      );
    }
  }
  ...
  public async deploySqlPair(
    ...
    try {
      ...
      return axios
        .post(`${this.cortexAIBaseEndpoint}/v1/sql-pairs`, body)
        .then((res) => {
  ...
  public async getSqlPairResult(queryId: string): Promise<SqlPairResult> {
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/sql-pairs/${queryId}`,
      );
  ...
  public async deleteSqlPairs(
    ...
    try {
      await axios.delete(`${this.cortexAIBaseEndpoint}/v1/sql-pairs`, {
        data: {
  ...
  public async ask(input: AskInput): Promise<AsyncQueryResponse> {
    try {
      const res = await axios.post(`${this.cortexAIBaseEndpoint}/v1/asks`, {
        query: input.query,
        id: input.deployId,
      ...
      logger.debug(`Got error when asking cortex ai: ${getAIServiceError(err)}`);
      throw err;
    }
  }
  ...
  public async cancelAsk(queryId: string): Promise<void> {
    ...
    try {
      await axios.patch(`${this.cortexAIBaseEndpoint}/v1/asks/${queryId}`, {
        status: 'stopped',
      });
    } catch (err: any) {
  ...
  public async getAskResult(queryId: string): Promise<AskResult> {
    ...
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/asks/${queryId}/result`,
      );
  ...
  public async getAskStreamingResult(queryId: string): Promise<Readable> {
    ...
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/asks/${queryId}/streaming-result`,
        { responseType: 'stream' },
      );
      return res.data;
    } catch (err: any) {
  ...
  public async generateAskDetail(
    ...
    try {
      const res = await axios.post(
        `${this.cortexAIBaseEndpoint}/v1/ask-details`,
        input,
      );
      return { queryId: res.data.query_id };
    } catch (err: any) {
  ...
  public async getAskDetailResult(queryId: string): Promise<AskDetailResult> {
    ...
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/ask-details/${queryId}/result`,
      );
  ...
  public async deploy(deployData: DeployData): Promise<cortexAIDeployResponse> {
    const { manifest, hash } = deployData;
    try {
      const res = await axios.post(
        `${this.cortexAIBaseEndpoint}/v1/semantics-preparations`,
        {
      ...
      logger.debug(
        `cortex ai: Deploying cortex ai, hash: ${hash}, deployId: ${deployId}`,
      );
      const deploySuccess = await this.waitDeployFinished(deployId);
      if (deploySuccess) {
        logger.debug(`cortex ai: Deploy cortex ai success, hash: ${hash}`);
        return { status: cortexAIDeployStatusEnum.SUCCESS };
      } else {
        return {
          status: cortexAIDeployStatusEnum.FAILED,
          error: `cortex ai: Deploy cortex ai failed or timeout, hash: ${hash}`,
        };
      }
    } catch (err: any) {
      logger.debug(
        `Got error when deploying to cortex ai, hash: ${hash}. Error: ${err.message}`,
      );
      return {
        status: cortexAIDeployStatusEnum.FAILED,
        error: `cortex ai Error: deployment hash:${hash}, ${err.message}`,
      };
    }
  }
  ...
  public async generateRecommendationQuestions(
    ...
    logger.info(`cortex ai: Generating recommendation questions`);
    try {
      const res = await axios.post(
        `${this.cortexAIBaseEndpoint}/v1/question-recommendations`,
        body,
      );
      logger.info(
        `cortex ai: Generating recommendation questions, queryId: ${res.data.id}`,
      );
  ...
  public async getRecommendationQuestionsResult(
    ...
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/question-recommendations/${queryId}`,
      );
  ...
  public async createTextBasedAnswer(
    ...
    try {
      const res = await axios.post(
        `${this.cortexAIBaseEndpoint}/v1/sql-answers`,
        body,
      );
      return { queryId: res.data.query_id };
    } catch (err: any) {
  ...
  public async getTextBasedAnswerResult(
    ...
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/sql-answers/${queryId}`,
      );
  ...
  public async streamTextBasedAnswer(queryId: string): Promise<Readable> {
    ...
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/sql-answers/${queryId}/streaming`,
        { responseType: 'stream' },
      );
      return res.data;
    } catch (err: any) {
  ...
  public async generateChart(input: ChartInput): Promise<AsyncQueryResponse> {
    try {
      const res = await axios.post(
        `${this.cortexAIBaseEndpoint}/v1/charts`,
        input,
      );
      return { queryId: res.data.query_id };
    } catch (err: any) {
  ...
  public async getChartResult(queryId: string): Promise<ChartResult> {
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/charts/${queryId}`,
      );
  ...
  public async cancelChart(queryId: string): Promise<void> {
    try {
      await axios.patch(`${this.cortexAIBaseEndpoint}/v1/charts/${queryId}`, {
        status: 'stopped',
      });
    } catch (err: any) {
  ...
  public async adjustChart(
    ...
    try {
      const res = await axios.post(
        `${this.cortexAIBaseEndpoint}/v1/chart-adjustments`,
  ...
  public async getChartAdjustmentResult(queryId: string): Promise<ChartResult> {
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/chart-adjustments/${queryId}`,
      );
      return this.transformChartResult(res.data);
    } catch (err: any) {
      logger.debug(
  ...
  public async generateQuestions(
    ...
    try {
      ...
      const res = await axios.post(
        `${this.cortexAIBaseEndpoint}/v1/sql-questions`,
        body,
      );
      return { queryId: res.data.query_id };
    } catch (err: any) {
  ...
  public async generateInstruction(
    ...
    try {
      const res = await axios.post(
        `${this.cortexAIBaseEndpoint}/v1/instructions`,
        body,
      );
      return { queryId: res.data.event_id };
    } catch (err: any) {
  ...
  public async getQuestionsResult(
    ...
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/sql-questions/${queryId}`,
      );
      const { status, error } = this.transformStatusAndError(res.data);
      return {
  ...
  public async getInstructionResult(
    ...
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/instructions/${queryId}`,
      );
  ...
  public async deleteInstructions(
    ...
    try {
      await axios.delete(`${this.cortexAIBaseEndpoint}/v1/instructions`, {
        data: {
  ...
  public async createAskFeedback(
    ...
    try {
      ...
      const res = await axios.post(
        `${this.cortexAIBaseEndpoint}/v1/ask-feedbacks`,
        body,
      );
      return { queryId: res.data.query_id };
    } catch (err: any) {
  ...
  public async getAskFeedbackResult(
    ...
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/ask-feedbacks/${queryId}`,
      );
  ...
  private async waitDeployFinished(deployId: string): Promise<boolean> {
    ...
    for (let waitTime = 1; waitTime <= 7; waitTime++) {
      try {
        ...
        logger.debug(`cortex ai: Deploy status: ${status}`);
        if (status === cortexAISystemStatus.FINISHED) {
          deploySuccess = true;
          break;
        } else if (status === cortexAISystemStatus.FAILED) {
          break;
        } else if (status === cortexAISystemStatus.INDEXING) {
          // do nothing
        } else {
          logger.debug(`cortex ai: Unknown cortex ai deploy status: ${status}`);
          return;
        }
      } catch (err: any) {
        throw err;
  ...
  private async getDeployStatus(deployId: string): Promise<cortexAISystemStatus> {
    try {
      const res = await axios.get(
        `${this.cortexAIBaseEndpoint}/v1/semantics-preparations/${deployId}/status`,
      );
      if (res.data.error) {
        // passing AI response error string to catch block
        throw new Error(res.data.error);
      }
      return res.data?.status.toUpperCase() as cortexAISystemStatus;
    } catch (err: any) {
      logger.debug(
  ...
  private transformStatusAndError(body: any): {
    ...
    // format custom error into cortexAIError that is used in graphql
