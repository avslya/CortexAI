...
import { cortex_AI_CONNECTION_INFO } from '../repositories';
import {
  toIbisConnectionInfo,
  toMultipleIbisConnectionInfos,
} from '../dataSource';
import { DialectSQL, cortexSQL } from '../models/adaptor';

export type { cortexSQL };
...
export interface IbisDryPlanOptions {
  dataSource: DataSourceName;
  mdl: Manifest;
  // TODO: replace sql type with cortexSQL
  sql: string;
}

export interface IIbisAdaptor {
  query: (
    // TODO: replace query type with cortexSQL
    query: string,
