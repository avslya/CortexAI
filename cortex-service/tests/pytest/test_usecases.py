...
cortex_AI_SERVICE_BASE_URL = "http://localhost:5556"
...
if __name__ == "__main__":
    ...
    assert is_ai_service_ready(
        cortex_AI_SERVICE_BASE_URL
    ), "cortexAI AI service is not running, please start it first via 'just up && just start'"
    ...
    for usecase, data in mdls_and_questions_by_usecase.items():
        ...
        semantics_preperation_id = deploy_mdl(data["mdl_str"], cortex_AI_SERVICE_BASE_URL)
