...
from src.utils import fetch_cortex_ai_docs
...
def create_service_container(
    ...
    cortex_ai_docs = fetch_cortex_ai_docs(settings.doc_endpoint, settings.is_oss)
    if not cortex_ai_docs:
        logger.warning("Failed to fetch cortex ai docs or response was empty.")
