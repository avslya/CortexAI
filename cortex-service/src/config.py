...
class Settings(BaseSettings):
    """
    Configuration settings for the cortex ai service.
    ...
    host: str = Field(default="127.0.0.1", alias="cortex_AI_SERVICE_HOST")
    port: int = Field(default=5555, alias="cortex_AI_SERVICE_PORT")
    ...
    doc_endpoint: str = Field(default="https://docs.getcortex.ai")
